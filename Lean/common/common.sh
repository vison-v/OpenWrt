...
rm -Rf feeds/packages/net/{smartdns,aria2,adguardhome,wrtbwmon} feeds/packages/lang/golang feeds/luci/themes/luci-theme-argon feeds/luci/applications/{luci-app-netdata,luci-app-baidupcs-web,luci-app-dockerman,luci-app-wrtbwmon,luci-app-watchcat,luci-app-ttyd,luci-app-unblockmusic,luci-app-pushbot}
##############定义函数################
function git_clone() {
...
git_sparse_clone main "https://github.com/kiddin9/kwrt-packages.git" wrtbwmon luci-app-wrtbwmon luci-app-watchcat luci-app-ttyd luci-app-unblockmusic luci-app-pushbot luci-app-smartdns luci-app-tcpdump && mv -n wrtbwmon package/openwrt-packages/
