...
git clone https://github.com/coolsnowwolf/luci -b master package/lede-packages && mv -n package/lede-packages/{luci-app-wrtbwmon,luci-app-watchcat,luci-app-ttyd,luci-app-unblockmusic,luci-app-serverchan} feeds/luci/applications/
