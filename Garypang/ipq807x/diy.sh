...
sed -i 's/DEFAULT_PACKAGES +=/DEFAULT_PACKAGES += autocore-arm luci-app-cpufreq kmod-qca-nss-drv kmod-qca-nss-dp nss-firmware-ipq8074 qca-ssdk-shell/' target/linux/ipq807x/Makefile
